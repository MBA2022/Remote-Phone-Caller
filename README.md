...
5. Run the Flask server on your phone:
```sh
python phone_server.py
```

6. Run the PC controller script:
```sh
...
9. Run the Flask server on your phone:
```sh
python phone_server.py
```

10. Run the PC controller script:
```sh
python pc_controller.py
```
...
Example command to initiate a call:
```sh
python pc_controller.py --call +1234567890
```
